...
class KnockoutController: BaseController {
    ...
    @IBOutlet weak var firstPersonKnockoutImageView: UIImageView!
    @IBOutlet weak var secondPersonKnockoutImageView: UIImageView!
    @IBOutlet weak var thirdPersonKnockoutImageView: UIImageView!
    @IBOutlet weak var fourthPersonKnockoutImageView: UIImageView!
    @IBOutlet weak var fifthPersonKnockoutImageView: UIImageView!
...
extension KnockoutController {
    
    func setupUI() {
        
        containerView.applyCornerRadius(cornerRadius: 12)
        firstPersonKnockoutImageView.applyCornerRadius(cornerRadius: 12, true)
        secondPersonKnockoutImageView.applyCornerRadius(cornerRadius: 12, true)
        thirdPersonKnockoutImageView.applyCornerRadius(cornerRadius: 12, true)
        fourthPersonKnockoutImageView.applyCornerRadius(cornerRadius: 12, true)
        fifthPersonKnockoutImageView.applyCornerRadius(cornerRadius: 12, true)
...
extension KnockoutController: UITableViewDataSource, UITableViewDelegate {
